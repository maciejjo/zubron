...
\end{itemize}
>>>>>>> 20896993465f349dc094377f1c4ac48d96f196a9
...
<<<<<<< HEAD
  Silniki umieszczono w tylnej części robota, mocując je za pomocą aluminiowych kątowników.
  Dodatkowym elementem układu jezdnego jest zamocowany w przedniej części caster, który został wykonany na tokarce w domowych warunkach w celu zmniejszenia kosztów projektu. Przednie koło zapewnia stabilność oraz poziomuje konstrukcję, zmniejsza tarcie i zwiększa zwrotność robota. 
