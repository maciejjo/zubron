...
Rysunki, obliczenia, rozwiązania, problemy, pomysły które odrzucono
  ...
  Podstawą konstrukcji nośnej i jednocześnie miejscem montażowym elementów elektronicznych jest laminat o wymiarach 100x80mm. 
  Ścieżki i miejsce przylutowania elementów zostały ulokowane w środkowej części płytki tak, aby możliwe było przymocowanie wszystkich podzespołów.
  Obie części zostały ze sobą połączone za pomocą szpilek M3 i śrub M3. 
  W ten sposób otrzymano spójną i sztywną konstrukcję mechaniczną.
  
  \textsc{Schemat płyty}
  
  \subsection{Układ jezdny}
  Robot napędzany jest dwoma silnikami firmy Micromotors o ciągłej rotacji (continous rotation) umiejscowionymi z tyłu.  
  Do silników przymocowano koła plastikowo-gumowe o średnicy 43mmx28mm firmy Lego. 
  Z przodu zamontowano caster własnej produkcji....
  Do sterowania prędkością i kierunkiem obrotów silników stosuje się sygnał PWM.
  Prędkość można regulować dla obu kierunków.
  Charakterystyka zastosowanych silników:
  \begin{itemize}
    \item prędkość kątowa: 60 obr./min.
    \item moment obrotowy: 3,4 kg/cm
    \item maks. napięcie zasilania: 6V
...
re rozwiązano, wariantów które odrzucono – dlaczego, ...), 
  Zasilanie układu jest dostarczane z pakietu 8 baterii o napięciu 1,5V.
  W układzie występują dwa napięcia:
  \begin{itemize} 
  \item 12V - napięcie akumulatora
  Wykorzystywane jest do zasilania silników poprzez sterowniki silników oraz jest wejściowym napięciem dla przetwornicy impulsowej
  \item 6V - napięcie zasilania logiki
  Jest to napięcie wyjściowe otrzymane z przetwornicy impulsowej. 
  Wykorzystywane jest ono dozasilania logiki układu sterującego, sterowników silników (logika). 
  \end{itemize}
